export default class Decoder {
  ...
  constructor(wasm, data) {
    ...
    const mp3DataInWasm = new Uint8Array(this.wasm.memory.buffer, this.wasm.mp3_data_base(), this.wasm.mp3_data_size());
  ...
  /**
   * Decodes MP3 data from the current position.
  ...
  decode(duration) {
    ...
    const pcm = new Int16Array(this.wasm.memory.buffer, this.wasm.pcm_data_base(), this.wasm.pcm_data_size() / 2);
    const results = {
      pcm: pcm,
      numSamples: this.wasm.num_samples(),
